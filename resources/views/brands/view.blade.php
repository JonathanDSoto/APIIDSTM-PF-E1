...
<div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-4">
            <h5 class="card-header">Información de la marca</h5>
            <div class="card-body">
                <div>
                    <label for="defaultFormControlInput" class="form-label">Marca</label>
                    <input type="text" class="form-control" id="defaultFormControlInput" placeholder="Toyota"
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Marcas /</span> Ver información de marca y vehiculos
        </h4>

        <!-- Vehicle List Table -->
        <div class="card">
            <div class="d-flex flex-row justify-content-between">
                <h5 class="card-header">Lista de vehiculos de la marca Toyota</h5>
